...
;;;;; Built-in syntax (Font-Lock)
     ...
     `(font-lock-function-name-face  ((,class (:foreground ,lambda-yellow :weight bold))))
     `(font-lock-keyword-face        ((,class (:foreground ,lambda-red :weight light :slant ,(if lambda-themes-set-italic-keywords 'italic 'normal)))))
     `(font-lock-string-face         ((,class (:foreground ,lambda-fg :background ,lambda-faint))))
     `(font-lock-variable-name-face  ((,class (:foreground ,lambda-yellow :weight bold))))
     `(font-lock-type-face           ((,class (:foreground ,lambda-orange :weight light))))

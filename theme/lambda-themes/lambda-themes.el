...
;;;;; Built-in syntax (Font-Lock)
     `(font-lock-builtin-face        ((,class (:foreground ,lambda-red :weight light))))
     `(font-lock-constant-face       ((,class (:foreground ,lambda-aqua :weight light))))
     ...
     `(font-lock-function-name-face  ((,class (:foreground ,lambda-yellow :weight light))))
     `(font-lock-keyword-face        ((,class (:foreground ,lambda-orange :weight bold))))
     `(font-lock-string-face         ((,class (:foreground ,lambda-meek :slant italic))))
     `(font-lock-variable-name-face  ((,class (:foreground ,lambda-yellow :weight light))))
     `(font-lock-type-face           ((,class (:foreground ,lambda-blue :weight light))))
...
;;;;;; lsp-mode
     `(lsp-ui-peek-peek ((,class (:background ,lambda-mild))))
     `(lsp-ui-peek-list ((,class (:background ,lambda-mild))))
     `(lsp-ui-peek-highlight ((,class (:background ,lambda-highlight))))
;;;;;; Consult
...
;;;;;; Diff
     ...
     `(diff-changed                              ((,class (:background nil :foreground ,lambda-blue))))
     `(diff-refine-changed                       ((,class (:foreground ,lambda-blue))))
     `(diff-added                                ((,class (:background nil :foreground ,lambda-green))))
     `(diff-refine-added                         ((,class (:background nil :foreground ,lambda-green))))
     `(diff-removed                              ((,class (:background nil :foreground ,lambda-red))))
     `(diff-refine-removed                       ((,class (:background nil :foreground ,lambda-meek :strike-through t))))
...
;;;;;; Ediff
     ...
     `(js2-jsdoc-tag                             ((,class (:background nil :foreground ,lambda-lowlight))))
     `(js2-jsdoc-type                            ((,class (:background nil :foreground ,lambda-highlight))))
     `(js2-jsdoc-value                           ((,class (:background nil :foreground ,lambda-lowlight))))
     `(js2-function-param                        ((,class (:background nil :foreground ,lambda-aqua))))
     `(js2-function-call                         ((,class (:background nil :foreground ,lambda-blue))))
     `(js2-instance-member                       ((,class (:background nil :foreground ,lambda-orange))))
     `(js2-private-member                        ((,class (:background nil :foreground ,lambda-yellow))))
     `(js2-private-function-call                 ((,class (:background nil :foreground ,lambda-aqua))))
     `(js2-jsdoc-html-tag-name                   ((,class (:background nil :foreground ,lambda-highlight))))
...
;;;;;; Magit
     ...
     `(magit-bisect-bad                     ((,class     (:foreground ,lambda-red))))
     `(magit-bisect-good                    ((,class     (:foreground ,lambda-green))))
     `(magit-bisect-skip                    ((,class     (:foreground ,lambda-yellow))))
     `(magit-blame-heading                  ((,class     (:foreground ,lambda-ultralight :background ,lambda-faint))))
     `(magit-branch-local                   ((,class     (:foreground ,lambda-blue))))
     `(magit-branch-current                 ((,class     (:underline ,lambda-blue :inherit 'magit-branch-local))))
     `(magit-branch-remote                  ((,class     (:foreground ,lambda-green))))
     `(magit-cherry-equivalent              ((,class     (:foreground ,lambda-purple))))
     `(magit-cherry-unmatched               ((,class     (:foreground ,lambda-aqua))))
     `(magit-diff-added                     ((,class     (:foreground ,lambda-green))))
     `(magit-diff-added-highlight           ((,class     (:foreground ,lambda-green :inherit 'magit-diff-context-highlight))))
     `(magit-diff-base                      ((,class     (:background ,lambda-yellow :foreground ,lambda-ultralight))))
     `(magit-diff-base-highlight            ((,class     (:background ,lambda-yellow :foreground ,lambda-ultralight))))
     `(magit-diff-context                   ((,class     (:foreground ,lambda-fg))))
     `(magit-diff-context-highlight         ((,class     (:background ,lambda-faint  :foreground ,lambda-strong))))
     `(magit-diff-hunk-heading              ((,class     (:background ,lambda-ultralight  :foreground ,lambda-strong))))
     `(magit-diff-hunk-heading-highlight    ((,class     (:background ,lambda-ultralight  :foreground ,lambda-strong))))
     `(magit-diff-hunk-heading-selection    ((,class     (:background ,lambda-faint  :foreground ,lambda-orange))))
     `(magit-diff-lines-heading             ((,class     (:background ,lambda-orange :foreground ,lambda-strong))))
     `(magit-diff-removed                   ((,class     (:foreground ,lambda-red :weight 'light))))
     `(magit-diff-removed-highlight         ((,class     (:foreground ,lambda-red :inherit 'magit-diff-context-highlight :weight 'light))))
     `(magit-diffstat-added                 ((,class     (:foreground ,lambda-green))))
     `(magit-diffstat-removed               ((,class     (:foreground ,lambda-red))))
     `(magit-filename                       ((,class     (:foreground ,lambda-strong :weight 'bold))))
     `(magit-hash                           ((,class     (:foreground ,lambda-blue))))
     `(magit-diff-file-heading              ((,class     (:foreground ,lambda-strong :weight 'bold))))
     `(magit-log-author                     ((,class     (:foreground ,lambda-red))))
     `(magit-log-date                       ((,class     (:foreground ,lambda-aqua))))
     `(magit-log-graph                      ((,class     (:foreground ,lambda-mild))))
     `(magit-process-ng                     ((,class     (:foreground ,lambda-red :weight 'bold))))
     `(magit-process-ok                     ((,class     (:foreground ,lambda-green :weight 'bold))))
     `(magit-reflog-amend                   ((,class     (:foreground ,lambda-purple))))
     `(magit-reflog-checkout                ((,class     (:foreground ,lambda-blue))))
     `(magit-reflog-cherry-pick             ((,class     (:foreground ,lambda-green))))
     `(magit-reflog-commit                  ((,class     (:foreground ,lambda-green))))
     `(magit-reflog-merge                   ((,class     (:foreground ,lambda-green))))
     `(magit-reflog-other                   ((,class     (:foreground ,lambda-aqua))))
     `(magit-reflog-rebase                  ((,class     (:foreground ,lambda-purple))))
     `(magit-reflog-remote                  ((,class     (:foreground ,lambda-blue))))
     `(magit-reflog-reset                   ((,class     (:foreground ,lambda-red))))
     `(magit-refname                        ((,class     (:foreground ,lambda-fg))))
     `(magit-section-heading-selection      ((,class     (:foreground ,lambda-focus))))
     `(magit-section-highlight              ((,class     (:background ,lambda-faint))))
     `(magit-sequence-drop                  ((,class     (:foreground ,lambda-focus))))
     `(magit-sequence-head                  ((,class     (:foreground ,lambda-aqua))))
     `(magit-sequence-part                  ((,class     (:foreground ,lambda-focus))))
     `(magit-sequence-stop                  ((,class     (:foreground ,lambda-green))))
     `(magit-signature-bad                  ((,class     (:foreground ,lambda-red :weight 'bold))))
     `(magit-signature-error                ((,class     (:foreground ,lambda-red))))
     `(magit-signature-expired              ((,class     (:foreground ,lambda-orange))))
     `(magit-signature-good                 ((,class     (:foreground ,lambda-green))))
     `(magit-signature-revoked              ((,class     (:foreground ,lambda-purple))))
...
;;;;;; Line numbers
     `(line-number                               ((,class (:foreground ,lambda-faint))))
...
;;;;;; Eshell
     ...
     `(eshell-ls-readonly                         ((,class (:foreground ,lambda-highlight))))
